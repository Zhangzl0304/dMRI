...
class TrainLoop:
    ...
    def run_loop(self, max_iter=11800, start_print_iter=10000, vis_batch_size=8, n_rounds=3):
        # if dist.get_rank() == 0:
        pbar = tqdm()
        while (
            self.step < max_iter
    ...
    def save_state_dict(self):
        ...
        # if dist.get_rank() == 0:
            ...
            with bf.BlobFile(bf.join(get_blob_logdir(), f"model_after100_{self.step}.pt"), "wb") as f:
